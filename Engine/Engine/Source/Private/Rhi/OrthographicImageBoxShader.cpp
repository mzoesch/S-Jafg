...
Jafg::TArray<Jafg::LShaderCompileTimeConstant> Jafg::LOrthographicImageBoxShader::GetDefaultConstants()
{
...
bool Jafg::LOrthographicImageBoxShader::Make(const LName InName, TArray<LShaderCompileTimeConstant>&& InConstants /* = {} */)
{
    ...
    LOG_VERBOSE(LogRhi, "Creating OrthographicImageBoxShader at [{}].", InName)
...
void Jafg::LOrthographicImageBoxShader::UpdateViewportUniforms(const LViewport& Context)
{
...
void Jafg::LOrthographicImageBoxShader::OnFree()
{
