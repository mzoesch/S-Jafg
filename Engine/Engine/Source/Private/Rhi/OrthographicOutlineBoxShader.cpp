...
void Jafg::LOrthographicOutlineBoxShader::UpdateViewportUniforms(const LViewport& Context)
{
...
void Jafg::LOrthographicOutlineBoxShader::OnFree()
{
...
void Jafg::LOrthographicOutlineBoxShader::Draw
(
