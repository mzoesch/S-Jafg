...
Jafg::TArray<Jafg::LShaderCompileTimeConstant> Jafg::LOrthographicOutlineImageBoxShader::GetDefaultConstants()
{
...
bool Jafg::LOrthographicOutlineImageBoxShader::Make(const LName InName, TArray<LShaderCompileTimeConstant>&& InConstants /* = {} */)
{
    ...
    LOG_VERBOSE(LogRhi, "Creating OrthographicOutlineImageBoxShader at [{}].", InName)
