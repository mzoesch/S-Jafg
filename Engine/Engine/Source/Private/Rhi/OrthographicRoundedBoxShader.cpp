...
bool Jafg::LOrthographicRoundedBoxShader::Make(const LName InName, TArray<LShaderCompileTimeConstant>&& InConstants /* = {} */)
{
    ...
    LOG_VERBOSE(LogRhi, "Creating OrthographicRoundedBoxShader at [{}].", InName)
...
void Jafg::LOrthographicRoundedBoxShader::UpdateViewportUniforms(const LViewport& Context)
{
...
void Jafg::LOrthographicRoundedBoxShader::OnFree()
{
