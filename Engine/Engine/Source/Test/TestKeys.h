...
TEST_CASE(ChunkKey, "Engine.Keys")
{
    ...
    CHECK_EQUALS( "ChunkKey conv to world.", LChunkKey(  0,  0,  0).ToWorldSpace(), LVector(  0.0f,   0.0f,   0.0f) )
    CHECK_EQUALS( "ChunkKey conv to world.", LChunkKey(  1,  1,  1).ToWorldSpace(), LVector( 32.0f,  32.0f,  32.0f) )
    CHECK_EQUALS( "ChunkKey conv to world.", LChunkKey(  2,  2,  2).ToWorldSpace(), LVector( 64.0f,  64.0f,  64.0f) )
    CHECK_EQUALS( "ChunkKey conv to world.", LChunkKey(  3,  3,  3).ToWorldSpace(), LVector( 96.0f,  96.0f,  96.0f) )
    CHECK_EQUALS( "ChunkKey conv to world.", LChunkKey( -1, -1, -1).ToWorldSpace(), LVector(-32.0f, -32.0f, -32.0f) )
    CHECK_EQUALS( "ChunkKey conv to world.", LChunkKey( -2, -2, -2).ToWorldSpace(), LVector(-64.0f, -64.0f, -64.0f) )
    CHECK_EQUALS( "ChunkKey conv to world.", LChunkKey( -3, -3, -3).ToWorldSpace(), LVector(-96.0f, -96.0f, -96.0f) )
...
TEST_CASE(VoxelKey, "Engine.Keys")
{
    ...
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(  0.0f,  0.0f,  0.0f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(  0.1f,  0.1f,  0.1f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(  0.9f,  0.9f,  0.9f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(  1.0f,  1.0f,  1.0f)), LVoxelKey(  1,  1,  1) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(  1.1f,  1.1f,  1.1f)), LVoxelKey(  1,  1,  1) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(  1.9f,  1.9f,  1.9f)), LVoxelKey(  1,  1,  1) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector( 31.9f, 31.9f, 31.9f)), LVoxelKey( 31, 31, 31) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector( 32.0f, 32.0f, 32.0f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector( 32.1f, 32.1f, 32.1f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector( 32.9f, 32.9f, 32.9f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector( 33.0f, 33.0f, 33.0f)), LVoxelKey(  1,  1,  1) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector( 33.1f, 33.1f, 33.1f)), LVoxelKey(  1,  1,  1) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector( 63.9f, 63.9f, 63.9f)), LVoxelKey( 31, 31, 31) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector( 64.0f, 64.0f, 64.0f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector( 64.1f, 64.1f, 64.1f)), LVoxelKey(  0,  0,  0) )

    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(- 0.1f,- 0.1f,- 0.1f)), LVoxelKey( 31, 31, 31) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(- 0.9f,- 0.9f,- 0.9f)), LVoxelKey( 31, 31, 31) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(- 1.0f,- 1.0f,- 1.0f)), LVoxelKey( 30, 30, 30) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(- 1.1f,- 1.1f,- 1.1f)), LVoxelKey( 30, 30, 30) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(- 1.9f,- 1.9f,- 1.9f)), LVoxelKey( 30, 30, 30) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(- 2.0f,- 2.0f,- 2.0f)), LVoxelKey( 29, 29, 29) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(- 2.1f,- 2.1f,- 2.1f)), LVoxelKey( 29, 29, 29) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-28.0f,-29.0f,-30.0f)), LVoxelKey(  3,  2,  1) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-31.0f,-31.0f,-31.0f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-31.9f,-31.9f,-31.9f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-32.0f,-32.0f,-32.0f)), LVoxelKey( 31, 31, 31) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-32.1f,-32.1f,-32.1f)), LVoxelKey( 31, 31, 31) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-32.9f,-32.9f,-32.9f)), LVoxelKey( 31, 31, 31) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-33.0f,-33.0f,-33.0f)), LVoxelKey( 30, 30, 30) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-33.1f,-33.1f,-33.1f)), LVoxelKey( 30, 30, 30) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-33.9f,-33.9f,-33.9f)), LVoxelKey( 30, 30, 30) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-34.0f,-34.0f,-34.0f)), LVoxelKey( 29, 29, 29) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-62.9f,-62.9f,-62.9f)), LVoxelKey(  1,  1,  1) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-63.0f,-63.0f,-63.0f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-63.1f,-63.1f,-63.1f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-63.9f,-63.9f,-63.9f)), LVoxelKey(  0,  0,  0) )
    CHECK_EQUALS( "VoxelKey conv from world.", LVoxelKey::FromWorldSpace(LVector(-64.0f,-64.0f,-64.0f)), LVoxelKey( 31, 31, 31) )
