...
#elif JAFG_PLATFORM_USES_UTF32
    #define JTXT(x) JTXTU(x)
#else /* JAFG_PLATFORM_USES_UTF32 */
...
#else /* JAFG_DO_SLOW_CHECKS */
    #define noexceptslow        noexcept // Slow checks will not compile so just mark as noexcept.
#endif /* !JAFG_DO_SLOW_CHECKS */
#if JAFG_DO_CHECKS
    #define noexceptcheck       // May throw.
#else /* JAFG_DO_CHECKS */
    #define noexceptcheck       noexcept // Checks will not compile so just mark as noexcept.
