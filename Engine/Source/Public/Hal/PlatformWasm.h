...
#define JAFG_PLATFORM_MAX_PATH                   _MAX_PATH
...
#define JAFG_PLATFORM_USES_NON_GENERIC_LOOP      1
#define PLATFORM_GUARDED_LOOP                              \
    ::emscripten_set_main_loop(::WasmGuardedLoop, 0, true)
#define JAFG_PLATFORM_USES_NON_GENERIC_EXIT      1
 ...
 */
#define JAFG_PLATFORM_NO_DISCARD_CTRL_PATH()
...
#define JAFG_PLATFORM_EXTERNSPEC_IN
