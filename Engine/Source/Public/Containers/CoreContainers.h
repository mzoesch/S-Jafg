...
inline constexpr bool __is_path_src<Jafg::TSimpleString<TChar, TTraits, TAlloc>> = __is_encoded_char<TChar>;

// SFINAE constraint for Source parameters as required by [fs.path.req].
template<typename _Tp>
using _JafgPath = enable_if_t<__is_path_src<_Tp>, Jafg::LSimplePath>;
...
using _JafgPath2 = enable_if_t<__is_path_iter_src<_Tr>, Jafg::LSimplePath>;

template<typename _CharT, typename _Traits, typename _Alloc>
inline basic_string_view<_CharT> __effective_range(Jafg::TSimpleString<_CharT, _Traits, _Alloc> const& __source) noexcept
{
    return __source;
}
...
//#
using _LString = Jafg::TSimpleString<LJafgChar>;
using _LWString = Jafg::TSimpleString<wchar_t>;
using _Lu8String = Jafg::TSimpleString<char8_t>;
using _Lu16String = Jafg::TSimpleString<char16_t>;
using _Lu32String = Jafg::TSimpleString<char32_t>;
...
public:
    ...
    std::filesystem::__cxx11::__detail::_JafgPath<_Source>& operator=(_Source const& __source)
    {
        return *this = path(__source);
    }
    template<typename _Source>
    std::filesystem::__cxx11::__detail::_JafgPath<_Source>& assign(_Source const& __source)
    {
        return *this = path(__source);
    }
    template<typename _InputIterator>
    std::filesystem::__cxx11::__detail::_JafgPath2<_InputIterator>& assign(_InputIterator __first, _InputIterator __last)
    {
    ...
    template<typename _Source>
    std::filesystem::__cxx11::__detail::_JafgPath<_Source>& append(_Source const& __source)
    {
    ...
    template<typename _InputIterator>
    std::filesystem::__cxx11::__detail::_JafgPath2<_InputIterator>& append(_InputIterator __first, _InputIterator __last)
    {
    ...
    template<typename _Source>
    std::filesystem::__cxx11::__detail::_JafgPath<_Source>& operator+=(_Source const& __x) { return TSuper::operator+=(__x), *this; }

    template<typename _CharT>
    std::filesystem::__cxx11::__detail::_JafgPath2<_CharT*>& operator+=(_CharT __x) { return TSuper::operator+=(__x), *this; }

    template<typename _Source>
    std::filesystem::__cxx11::__detail::_JafgPath<_Source>& concat(_Source const& __x)
    {
        TSuper::concat(__x);
        return *this;
    }
    ...
    template<typename _InputIterator>
    std::filesystem::__cxx11::__detail::_JafgPath2<_InputIterator>& concat(_InputIterator __first, _InputIterator __last)
    {
...
#if JAFG_WITH_CLANG && _GLIBCXX_USE_WCHAR_T
    _LWString   wstring() const { return string<_LWString::value_type, _LWString::traits_type, _LWString::allocator_type>(); }
#endif /* JAFG_WITH_CLANG && _GLIBCXX_USE_WCHAR_T */
#if JAFG_WITH_CLANG && defined(_GLIBCXX_USE_CHAR8_T)
    __attribute__((__abi_tag__("__u8")))
#endif /* JAFG_WITH_CLANG && _GLIBCXX_USE_CHAR8_T */
    ...
    template<typename _Source, typename _Require = std::filesystem::__cxx11::__detail::_JafgPath<_Source>>
...
static_assert(Detail::TIsPathSourceValid_v<std::string>);
static_assert(Detail::TIsPathSourceValid_v<TSimpleString<char>>);
...
using LString = Jafg::_LString;
using LWString = Jafg::_LWString;
using Lu8String = Jafg::_Lu8String;
using Lu16String = Jafg::_Lu16String;
using Lu32String = Jafg::_Lu32String;
