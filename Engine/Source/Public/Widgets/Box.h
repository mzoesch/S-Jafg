...
public:
    ...
    FORCEINLINE TFactoryRetTy& ImageTint(const LColor& InImageTint) { this->This()->SetImageTint(InImageTint); return this->Self(); }
    ...
    FORCEINLINE TFactoryRetTy& OutlineRadii(const LVec4F& InOutlineRadii) { this->This()->SetOutlineRadii(InOutlineRadii); return this->Self(); }
...
public:
    ...
    FORCEINLINE void SetBrush(const LBoxBrush& InBrush) noexcept { this->Brush = InBrush; }
