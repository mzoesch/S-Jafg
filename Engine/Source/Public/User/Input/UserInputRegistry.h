...
public:
    ...
    FORCEINLINE LUserInputContext*       GetContextByName(LUserInputTag Name) noexcept { return algo::wfind_pointer(this->Contexts, Name, &LUserInputContext::GetTag); }
    FORCEINLINE LUserInputContext const* GetContextByName(LUserInputTag Name) const noexcept { return algo::wfind_pointer(this->Contexts, Name, &LUserInputContext::GetTag); }
    ...
    FORCEINLINE LInputAction*       GetActionByName(LUserInputTag Name) noexcept { return algo::wfind_pointer(this->Actions, Name, &LInputAction::GetTag); }
    FORCEINLINE LInputAction const* GetActionByName(LUserInputTag Name) const noexcept { return algo::wfind_pointer(this->Actions, Name, &LInputAction::GetTag); }
