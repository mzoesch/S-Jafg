...
if(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
    ...
    set(COMPILER_SUPPORTS_SHARED_LNK ON)
elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
    ...
    if(REGREX_MATCHED)
        set(USING_MSVC OFF)
        set(USING_MINIMAL ON)
        set(COMPILER_SUPPORTS_SHARED_LNK OFF)
    else()
...
if(USING_MINIMAL)
    if(COMPILER_SUPPORTS_SHARED_LNK)
...
`,
    ...
    WriteWithIndent(builder, 0, "message(STATUS \"Supports shared linking: ${COMPILER_SUPPORTS_SHARED_LNK}.\")\n")
