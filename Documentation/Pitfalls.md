...
The codebase therefore (because I use mostly CLion and Rider) does not contain any multiline docs and comments where the Jafg build tool might be encountered...
