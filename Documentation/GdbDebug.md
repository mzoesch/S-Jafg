...
To create your own Gdb customization script, create a file named `GdbModuleEntry.py` in the `Debug` folder under the `Source` folder of your Jafg module. E.g. `Engine/Source/Debug/GdbModuleEntry.py`.
