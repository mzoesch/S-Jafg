...
fn write_packet(b: &BuildTarget, unit: JPacketUnit) -> i32
{
    let mut changes: i32 = 0;

    let stub: String = get_generated_file_stub_checked(&unit.name);
    let gh_file: String = format!("{}/{}.generated.h", b.solution.construct_relative_gh_path(b.platform, b.module), stub);
    let gt_file: String = format!("{}/{}.generated.cpp", b.solution.construct_relative_gt_path(b.platform, b.module), stub);
    ensure_file(&gh_file);
    ensure_file(&gt_file);
...
fn delete_packet(b: &BuildTarget, unit: String) -> i32
{
