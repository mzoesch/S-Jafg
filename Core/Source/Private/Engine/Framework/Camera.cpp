...
void Camera::ProcessKeyboard(const Camera_Movement Dir, const float DeltaTime)
{
    ...
    const glm::vec3 Up = glm::vec3(LVector::UpVector.X, LVector::UpVector.Y, LVector::UpVector.Z);
