...
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::ZeroVector                { LInt8Vector( 0,  0,  0) };
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::OneVector                 { LInt8Vector( 1,  1,  1) };
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::UpVector                  { LInt8Vector( 0,  0,  1) };
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::DownVector                { LInt8Vector( 0,  0, -1) };
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::ForwardVector             { LInt8Vector( 1,  0,  0) };
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::BackwardVector            { LInt8Vector(-1,  0,  0) };
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::RightVector               { LInt8Vector( 0,  1,  0) };
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::LeftVector                { LInt8Vector( 0, -1,  0) };
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::UnitVectorX               { LInt8Vector( 1,  0,  0) };
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::UnitVectorY               { LInt8Vector( 0,  1,  0) };
template<> SPECIALIZATION_API const LInt8Vector LInt8Vector::UnitVectorZ               { LInt8Vector( 0,  0,  1) };

template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::ZeroVector              { LInt16Vector( 0,  0,  0) };
template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::OneVector               { LInt16Vector( 1,  1,  1) };
template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::UpVector                { LInt16Vector( 0,  0,  1) };
template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::DownVector              { LInt16Vector( 0,  0, -1) };
template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::ForwardVector           { LInt16Vector( 1,  0,  0) };
template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::BackwardVector          { LInt16Vector(-1,  0,  0) };
template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::RightVector             { LInt16Vector( 0,  1,  0) };
template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::LeftVector              { LInt16Vector( 0, -1,  0) };
template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::UnitVectorX             { LInt16Vector( 1,  0,  0) };
template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::UnitVectorY             { LInt16Vector( 0,  1,  0) };
template<> SPECIALIZATION_API const LInt16Vector LInt16Vector::UnitVectorZ             { LInt16Vector( 0,  0,  1) };

template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::ZeroVector              { LInt32Vector( 0,  0,  0) };
template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::OneVector               { LInt32Vector( 1,  1,  1) };
template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::UpVector                { LInt32Vector( 0,  0,  1) };
template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::DownVector              { LInt32Vector( 0,  0, -1) };
template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::ForwardVector           { LInt32Vector( 1,  0,  0) };
template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::BackwardVector          { LInt32Vector(-1,  0,  0) };
template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::RightVector             { LInt32Vector( 0,  1,  0) };
template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::LeftVector              { LInt32Vector( 0, -1,  0) };
template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::UnitVectorX             { LInt32Vector( 1,  0,  0) };
template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::UnitVectorY             { LInt32Vector( 0,  1,  0) };
template<> SPECIALIZATION_API const LInt32Vector LInt32Vector::UnitVectorZ             { LInt32Vector( 0,  0,  1) };

template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::ZeroVector              { LInt64Vector( 0,  0,  0) };
template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::OneVector               { LInt64Vector( 1,  1,  1) };
template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::UpVector                { LInt64Vector( 0,  0,  1) };
template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::DownVector              { LInt64Vector( 0,  0, -1) };
template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::ForwardVector           { LInt64Vector( 1,  0,  0) };
template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::BackwardVector          { LInt64Vector(-1,  0,  0) };
template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::RightVector             { LInt64Vector( 0,  1,  0) };
template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::LeftVector              { LInt64Vector( 0, -1,  0) };
template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::UnitVectorX             { LInt64Vector( 1,  0,  0) };
template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::UnitVectorY             { LInt64Vector( 0,  1,  0) };
template<> SPECIALIZATION_API const LInt64Vector LInt64Vector::UnitVectorZ             { LInt64Vector( 0,  0,  1) };

template<> SPECIALIZATION_API const LInt8Vector2 LInt8Vector2::ZeroVector              { LInt8Vector2(0, 0) };
template<> SPECIALIZATION_API const LInt8Vector2 LInt8Vector2::OneVector               { LInt8Vector2(1, 1) };
template<> SPECIALIZATION_API const LuInt8Vector2 LuInt8Vector2::ZeroVector            { LuInt8Vector2(0u, 0u) };
template<> SPECIALIZATION_API const LuInt8Vector2 LuInt8Vector2::OneVector             { LuInt8Vector2(1u, 1u) };

template<> SPECIALIZATION_API const LInt16Vector2 LInt16Vector2::ZeroVector            { LInt16Vector2(0, 0) };
template<> SPECIALIZATION_API const LInt16Vector2 LInt16Vector2::OneVector             { LInt16Vector2(1, 1) };
template<> SPECIALIZATION_API const LuInt16Vector2 LuInt16Vector2::ZeroVector          { LuInt16Vector2(0u, 0u) };
template<> SPECIALIZATION_API const LuInt16Vector2 LuInt16Vector2::OneVector           { LuInt16Vector2(1u, 1u) };

template<> SPECIALIZATION_API const LInt32Vector2 LInt32Vector2::ZeroVector            { LInt32Vector2(0, 0) };
template<> SPECIALIZATION_API const LInt32Vector2 LInt32Vector2::OneVector             { LInt32Vector2(1, 1) };
template<> SPECIALIZATION_API const LuInt32Vector2 LuInt32Vector2::ZeroVector          { LuInt32Vector2(0u, 0u) };
template<> SPECIALIZATION_API const LuInt32Vector2 LuInt32Vector2::OneVector           { LuInt32Vector2(1u, 1u) };

template<> SPECIALIZATION_API const LInt64Vector2 LInt64Vector2::ZeroVector            { LInt64Vector2(0, 0) };
template<> SPECIALIZATION_API const LInt64Vector2 LInt64Vector2::OneVector             { LInt64Vector2(1, 1) };
template<> SPECIALIZATION_API const LuInt64Vector2 LuInt64Vector2::ZeroVector          { LuInt64Vector2(0u, 0u) };
template<> SPECIALIZATION_API const LuInt64Vector2 LuInt64Vector2::OneVector           { LuInt64Vector2(1u, 1u) };
